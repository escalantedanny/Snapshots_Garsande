...
import com.descalante.snapshotsgarsande.databinding.FragmentHomeBinding
import com.descalante.snapshotsgarsande.databinding.ItemSnapshotBinding
            ...
            override fun onBindViewHolder(holder: SnapshotHolder, position: Int, model: Snapshot) {
                ...
                with(holder){
                    ...
                    FirebaseAuth.getInstance().currentUser?.let {
                        if(snapshot.email == FirebaseAuth.getInstance().currentUser?.email){
